#!/usr/bin/env python3
"""Train and evaluate unordered item co-occurrence recommender."""
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for co-occurrence experiment."""
...
def main() -> None:
    """Run co-occurrence model training + evaluation."""
    ...
    output_path = args.output or (METRICS_DIR / f"cooccurrence_{args.split}.json")
