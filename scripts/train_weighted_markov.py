#!/usr/bin/env python3
"""Train and evaluate recency-weighted Markov recommender."""
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for weighted Markov experiment."""
...
def main() -> None:
    """Run weighted Markov model training + evaluation."""
    ...
    output_path = args.output or (METRICS_DIR / f"weighted_markov_{args.split}.json")

    model = WeightedMarkovRecommender(
        decay=args.decay,
        alpha=args.alpha,
